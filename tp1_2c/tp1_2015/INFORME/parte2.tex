...
\begin{center}
	...
	{$Lote 1$ - Scheduler RR - 1 core - 5 quantum}	
...
desde que fue cargado en el core.
\item Un map de pair\textless \ int, int\textgreater \ $pid_Tarde$ este nos indicara dependiendo el pid si la tarea fue cargada al iniciar el lote o si llego mas 
tarde
